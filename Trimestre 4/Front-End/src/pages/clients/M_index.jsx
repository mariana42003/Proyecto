...
export default function M_index() {
  ...
  useEffect(() => {
    const hayAlgoAbierto =
      carritoAbierto || modalLoginAbierto || modalRegistroAbierto || modalPedidosAbierto;
    document.body.classList.toggle('modal-activo', hayAlgoAbierto);
  ...
  return (
    <>
        ...
        <nav className="nav-principal">
          <div className="nav-principal__inner">
            ...
            <div className="nav-principal__acciones">
              ...
              {/* SESIÓN CONDICIONAL EN NAVEGACIÓN */}
              {usuario ? (
                <div className="nav-principal__usuario">
                  <span className="nav-principal__usuario-nombre" title={nombreUsuario}>
                    {nombreUsuario}
                  </span>
                  <button
      ...
      <div className={`menu-movil ${menuMovilAbierto ? 'activo' : ''}`}>
        {usuario ? (
          <>
            <span className="menu-movil__usuario">
              <IconUser size={16} /> {nombreUsuario}
            </span>
            <button
              type="button"
              ...
              onClick={cerrarSesionUsuario}
            >
              <IconUserTie size={16} /> Cerrar sesión
            </button>
          </>
        ) : (
          <button
        ...
        <a href="/garantias"><IconShield size={16} /> Garantía</a>
      </div>
        ...
        <div className="tienda">
          <aside className="barra-lateral">
            <nav className="menu-lateral" aria-label="Categorías">
              ...
              <a href="/garantias" className="opcion">
      ...
      {/* OVERLAY FONDO MODAL */}
      {(modalLoginAbierto || modalRegistroAbierto || modalPedidosAbierto) && (
        <div
