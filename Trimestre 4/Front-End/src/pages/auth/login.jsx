...
export default function Login({ abierto = true, alCerrar }) {
  ...
  try {
    // 1. Iniciar sesión y obtener el usuario
    ...
    // 2. Consultar el rol en la tabla de perfiles
    ...
    // 3. Determinar el rol (usa un rol por defecto si no existe)
    const rolUsuario = perfil?.rol || "cliente";
    ...
    // 5. Cerrar modal/formulario y redirigir
    cerrar();
