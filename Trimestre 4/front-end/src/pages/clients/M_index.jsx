...
export default function M_index() {
  ...
  const confirmarCompra = async () => {
    ...
    try {
      ...
      // La "salida" de material (descuento real de stock + registro en
      // "movimientos") NO se hace desde aquí: las políticas RLS de
      // "productos" y "movimientos" solo permiten escribir a
      // jefe/administrador, así que un intento desde la sesión del
      // cliente simplemente fallaría. En cambio, este pedido ya queda
      // visible en tiempo real para el jefe en Órdenes > Historial de
      // compras (A_historial.jsx), y es al ACEPTAR esa orden ahí donde
      // se genera la salida real — ver esa página para el detalle.
      setCarrito([]);
      setCarritoAbierto(false);
      Swal.fire({
